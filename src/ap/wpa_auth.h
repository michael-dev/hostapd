 ...
 *  | multiple of of struct ft_rrb_tlv (aes-siv encrypted, all-zero padded to blocksize, aes-siv needs an extra blocksize length) |
 */
...
#define FT_RRB_MOBILITY_DOMAIN  18 /* MOBILITY_DOMAIN_ID_LEN */
...
struct ft_remote_seq {
	...
	struct dl_list queue; /* rrb packets waiting for seq resp */
};
